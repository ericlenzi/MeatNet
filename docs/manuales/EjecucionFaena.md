...
| `CatalogoSimpleListPage` / `CatalogoSimpleFormPage` | `/tipos-puestos`, `/tipos-mediciones` | Administración *(solo SUPERADMIN)* | Un **único par de pantallas** para los dos catálogos de código y nombre; cuál es lo define una prop, igual que los ejes del palco. |
