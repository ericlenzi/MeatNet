...
namespace Meat.Repositories.Migrations
{
    ...
    [Migration("20260519151931_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Meat.Domain.Empleados.Empleado", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Meat.Domain.EmpleadosSucursales.EmpleadoSucursal", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Meat.Domain.ParametrosSucursales.ParametroSucursal", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ParametrosSucursales");
                });
            ...
            modelBuilder.Entity("Meat.Domain.EmpleadosSucursales.EmpleadoSucursal", b =>
                {
                    b.HasOne("Meat.Domain.Empleados.Empleado", "Empleado")
                        .WithMany()
            ...
            modelBuilder.Entity("Meat.Domain.ParametrosSucursales.ParametroSucursal", b =>
                {
                    b.HasOne("Meat.Domain.Parametros.Parametro", "Parametro")
                        .WithMany()
                        .HasForeignKey("ParametroId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Meat.Domain.Sucursales.Sucursal", null)
                        .WithMany("ParametrosSucursal")
                        .HasForeignKey("SucursalId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Meat.Domain.Usuarios.Usuario", b =>
                {
                    b.HasOne("Meat.Domain.Empleados.Empleado", "Empleado")
                        .WithOne("Usuario")
                        .HasForeignKey("Meat.Domain.Usuarios.Usuario", "EmpleadoId");

                    b.HasOne("Meat.Domain.Empresas.Empresa", "Empresa")
                        .WithMany()
                        .HasForeignKey("EmpresaId");

                    b.OwnsOne("Meat.Domain.Usuarios.Credencial", "Credencial", b1 =>
                        {
            ...
            modelBuilder.Entity("Meat.Domain.Sucursales.Sucursal", b =>
                {
                    b.Navigation("ParametrosSucursal");
