    ...
    children: [
      {
        ...
        items: [
          ...
          { label: 'Tipos de Puesto', path: '/tipos-puestos', icon: icons.tag, superAdminOnly: true },
          { label: 'Tipos de Medición', path: '/tipos-mediciones', icon: icons.tag, superAdminOnly: true },
          { label: 'Categorias de Hacienda', path: '/categorias-hacienda', icon: icons.tag },
          { label: 'Puestos', path: '/puestos', icon: icons.desktopComputer },
          { label: 'Tipificadores', path: '/tipificadores', icon: icons.users },
