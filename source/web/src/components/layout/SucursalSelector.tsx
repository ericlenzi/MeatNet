  ...
  return (
    <div className="relative" ref={dropdownRef}>
      <button
        ...
        className="flex items-center gap-2 rounded-lg border border-border bg-white px-3 py-1.5 text-sm text-text hover:bg-gray-50 transition-colors"
      >
      ...
      {isOpen && (
        <div className="absolute right-0 top-full z-50 mt-1 w-64 rounded-lg border border-border bg-white py-1 shadow-lg">
          {sucursales.map((s) => (
            <button
              key={s.id}
              onClick={() => {
