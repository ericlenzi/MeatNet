...
import type { Categoria, Especie } from '@/types'
    ...
    },
    {
      ...
      render: (_, row) => (
        <div className="flex items-center gap-1">
          <button
            onClick={(e) => { e.stopPropagation(); navigate(`/categorias/${row.id}/edit`) }}
  ...
  return (
    <>
      <PageHeader title="Categorias">
        <Button onClick={() => navigate('/categorias/create')}>Nueva Categoria</Button>
      </PageHeader>
      ...
      <ConfirmDialog
        ...
        message={`¿Esta seguro que desea eliminar la categoria "${deleteTarget?.nombre}"?`}
