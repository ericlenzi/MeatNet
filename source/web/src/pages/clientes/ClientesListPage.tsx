...
export default function ClientesListPage() {
  ...
  const columns: Column<Cliente>[] = [
    { key: 'codigoCliente', header: 'Codigo', width: '120px', sortable: true },
    { key: 'nombre', header: 'Nombre', sortable: true },
    { key: 'tipoClienteNombre', header: 'Tipo', width: '150px', sortable: true },
    { key: 'numeroCuit', header: 'CUIT', width: '140px', sortable: true },
    {
      key: 'activo',
      header: 'Estado',
      width: '100px',
    ...
    },
    {
      ...
      render: (_, row) => (
        <div className="flex items-center gap-1">
          <button
            onClick={(e) => { e.stopPropagation(); navigate(`/clientes/${row.id}/edit`) }}
  ...
  return (
    <>
      <PageHeader title="Clientes">
        <Button onClick={() => navigate('/clientes/create')}>Nuevo Cliente</Button>
      </PageHeader>
      ...
      <div className="mb-4 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
        <SearchInput
          ...
          placeholder="Buscar por codigo, nombre, CUIT..."
        />
      ...
      <ConfirmDialog
        ...
        message={`¿Esta seguro que desea eliminar el cliente "${deleteTarget?.nombre}"?`}
