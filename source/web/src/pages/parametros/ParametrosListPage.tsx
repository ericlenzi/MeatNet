...
export default function ParametrosListPage() {
  ...
  return (
    <>
      <PageHeader title="Parametros Generales">
        <Button onClick={() => navigate('/parametros/create')}>Nuevo Parametro</Button>
      </PageHeader>
      ...
      <ConfirmDialog
        ...
        message={`¿Esta seguro que desea eliminar el parametro "${deleteTarget?.nombre}"?`}
