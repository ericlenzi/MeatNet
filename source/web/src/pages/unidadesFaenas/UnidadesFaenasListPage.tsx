...
export default function UnidadesFaenasListPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      toast('error', 'Error al cargar unidades de faena')
    } finally {
      setIsLoading(false)
    }
  ...
  return (
    <>
      <PageHeader title="Unidades de Faena">
        <Button onClick={() => navigate('/unidades-faenas/create')}>Nueva Unidad</Button>
      </PageHeader>
      ...
      <ConfirmDialog
        ...
        title="Eliminar unidad de faena"
        message={`¿Esta seguro que desea eliminar la unidad "${deleteTarget?.nombre}"?`}
